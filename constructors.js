...
function CarFactory(make,model) {this.make = make; this.model = model;};
...
function Car(make,model,year) {this.make = make; this.model = model; this.year=year; this.move = 0; this.moveCar = () =>{this.move+=10; return this.move;}}
